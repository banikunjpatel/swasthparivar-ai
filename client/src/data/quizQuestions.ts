...
export const quizQuestions: QuizQuestion[] = [
  ...
  //     {
  //       label: "A",
  //       text: "Hummingbird Mind",
  //       description: "Constantly jumping between thoughts, tabs, and ideas",
  //       image: q11ScatteredFocus
  //     },
  //     {
  //       label: "B",
  //       text: "Laser Focus",
  //       description: "I can lock onto a task when it's engaging, but get impatient by interruptions",
  //       image: q11LaserFocus
  //     },
  //     {
  //       label: "C",
  //       text: "Deep & Steady",
  //       description: "It takes me time to start, but once I do, my focus is incredibly deep",
  //       image: q11DeepFocus
  //     }
  //   ],
  //   category: 'vata'
